...
In Section~\ref{sec:research} we propose \TODO{number} research questions we believe need more study and discuss how these questions have informed the design of our game. 
...
We are especially concerned with these questions as they relate to novice programmers, so we have tried to make \gametitle{} accessible to players as young as 9. \TODO{how have we made it accessible}

\subsection{Scaffolded Sandbox}
\TODO{presumably this should be connected to whatever discussion of guided discovery learning appears earlier}
\TODO{phase this as a question, not a goal}
