...
While the pure form of this approach can work for simple learning domains, complex ones such as programming or computational thinking cannot be taught through exploration alone unless players have sufficient background knowlege~\cite{kirschner2006minimal}. 

\TODO{cite the discovery-learning-sucks-wihtout-guidance paper}~\cite{mayer2004should}
...
\emph{Scratch} users, for example, have shared millions of projects and even formed online \emph{companies} to tackle projects together~\cite{resnick2009scratch}. 
...
Open-world multiplyer games, notably \emph{Mincraft}, have been used effectively as a virtual classroom environment~\TODO{cite}.
...
This works naturually in multiplayer games such as \emph{Minecraft}, where players on the same game server can explore and shape a persistent world together.
...
The total set of features and stategies avliable are quite large, and freedom to learn \emph{all} of them immediately may overwhelm players.
...
For example, a friend in \emph{Minecraft} can jumpstart a new player by giving them tools and showing them around.
...
\emph{MinecraftEdu}~\cite{minecraftedu} is an official varient of \emph{Minecraft} with a number of classroom-centric features. 
