...
public class TLLine2 : MonoBehaviour
{
	...
	void Start() {
        ...
        GetComponent<AllTheGUI>().CurrentMessage = "In this challenge, try to place at least 100 blocks in a space that is at least 30 spaces wide and 30 spaces long. The number in the <b>Line</b> statement controls how long the line is. Change this number to make the line longer.";
