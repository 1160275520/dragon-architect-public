...
public class TLMovementArgs : MonoBehaviour
{
    ...
    void Start() {
        ...
        GetComponent<AllTheGUI>().CurrentMessage = "Help me put blocks on the blue boxes! The number in each <object data=\"media/forward.svg\" style=\"vertical-align:middle\"></object> tells me how many spaces to move. Change the numbers to complete my program.";
